...
<body>
	<div id="wrapper">
		 <%@include file ="adminNav.jsp" %>
          ...
          <div id="page-wrapper">
          		<div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" style="font-family: Gugi;">반디불이 책넣기</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" onsubmit="">
                                        ...
                                        <button type="submit" class="btn btn-default" id ="bsubmit" onsubmit="return false;">Submit Button</button>
	...
	<script>
			...
			if(checkValidate())
			{
				$.ajax({
					...
					success: function(data) {
						...
						$('#day').val("");
						$('#quant').val("");
						$('#genre').val('default').prop("selected",true);
						/* $('#bsubmit').submit(); */ 
		...
		function checkValidate()
		{
			...
			}else if($('#genre option:selected').val() =="default")
			{
				alert('장르 선택 해주세요');
				key = false;	
			}
