<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <div class ="w3-container" style =" padding-top:30px; margin-top:100px; background: #9F86AA">
 	...
 	<div style  ="display: block; padding-right: 20%;" class ="w3-right">
	 	...
	 	<h5 style ="color:snow;" class = >사업자  등록 번호 : H - CLASS</h5>
	 	<h5 style ="color:snow;" class = >대표 전화 :010-5877-8378</h5>
	 	<h5 style ="color:snow;" class = >COPYRIGHT(C) BANDI BOOK CENTRE ALL RIGHTS RESERVED.</h5>
 	</div>
 	<h1 style ="color:snow; padding-top: 8%;" class ="w3-center">BANDI BOOKS</h1>
